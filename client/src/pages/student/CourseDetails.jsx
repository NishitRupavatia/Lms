  ...
  return courseData ? (
    <>
      <div className='flex md:flex-row flex-col-reverse gap-10 relative items-start justify-between md:px-36 px-8 md:pt-30 pt-20 text-left'>
        ...
        {/* Background */}
        <div className='absolute top-0 left-0 w-full h-section-height z-0 bg-linear-to-b from-cyan-100/70 to-transparent'></div>
        ...
        {/* RIGHT COLUMN */}
        <div className='max-w-course-card z-10 shadow-custom-card rounded-t-md md:rounded-none overflow-hidden bg-white min-w-75 sm:min-w-105'>
